...
Get random names from github follow names.

![github-follow-names](other/github-follow-names.gif)
...
```
npm install github-follow-names
```

## Usage

```javascript
var names = require('github-follow-names');
